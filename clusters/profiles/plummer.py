...
class Plummer(DensityProfile):
    ...
    def rh(self, t: float): return (self.R0**1.5 + self.A * t)**(2/3)
    def a(self, t: float): return 0.766 * self.rh(t)
    def M_t(self, t: float): return self.M0 + (self.M1 - self.M0) * (t / self.T_AGE)
