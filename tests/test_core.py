...
def test_is_analytic_valid_thresholds(monkeypatch):
    monkeypatch.setattr(
        core, "tidal_param", lambda **kwargs: core.T_MIN + 10, raising=False
    )
    monkeypatch.setattr(
        core, "slow_param", lambda **kwargs: core.S_MIN + 10, raising=False
    )
...
def test_tidal_effect_non_increasing():
    ...
    m1 = 1.0
    m2 = 1e-3
    e_new, a_new = core.tidal_effect(e=e0, a=a0, m1=m1, m2=m2, time_in_Myr=0.1, C=0.01)
