...
def true_anomaly_approximation(
    mean_anom: float,
    e: float
) -> float:
    """
...
def de_sim(
    ...
    """
    Calculates the eccentricity excitation using the REBOUND code
    with full N-body integration
    """
